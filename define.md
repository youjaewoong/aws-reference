...
#### Trusted Advisor
 - AWS 모범 사례를 따르는데 도움이 되는 권장사항을 제공 합니다.
...
#### KMS (SSE-KMS)
 ...
 - 거의 실시간으로 인증서를 암호화하고 해독할수 있는 솔루션
...
#### Aurora
 ...
 - RDS 프록시 : 데이터 베이스 열린 연결수 제어 가능

#### RDS for
 - State Manger : RDS를 일정에 따라 중지 및 시작할수 있습니다.
...
#### WAF
 - DDoS 공격 방어 가능
 - 특정 국가에서만 엑세스 제한 가능
 - ALB, API Gateway, CloudFront 연결 가능

#### Shield Advanced
 - DDos 공격 방지 솔루션
 - ELB, CloudFront, Route53, Global Accelerator, EC2 연결 가능
...
#### Network Firewall
 - VPC로 들어오고 나가는트래픽을 검사, 필터링, 침입 탐지 및 보호 가능
...
#### SageMaker
 - 머신러닝 모델 구축, 훈련, 배포 서비스

#### Comprehend Medical
 - 의료 데이터를 추출하는 머신러닝 서비스
...
#### Firewall Manager
 - AWS Firewall Manager는 AWS Organizations의 여러 계정과 애플리케이션에 대한 방화벽 규칙을 중앙에서 구성하고 관리할 수 있는 보안 관리 서비스입니다.

#### AppFlow
 - SaaS 애플리케이션과 AWS 간의 데이터를 전송해 주는 서비스
